...
<h1>Товары</h1>
<p><a href="/add">+ Добавить / обновить товар</a></p>
<table border="1" cellpadding="6" cellspacing="0" style="border-collapse: collapse;">
<tr>
<th>Артикул</th><th>Название</th><th>Себестоимость</th><th>Мин.маржа</th><th>Мин.прибыль</th><th>Цель прибыль</th>
</tr>
{% for s in skus %}
<tr>
...
<p><label>{{ label }}<br><input type="text" name="{{ field }}" required style="width:100%; box-sizing: border-box; padding:6px;"></label></p>
{% endfor %}
...
def add():
    if request.method == "POST":
        ...
        conn.close()
        return redirect("/")
    return render_template_string(TEMPLATE_FORM, fields=FIELDS)
