...
FIELDS = [
    ("nm_id","Артикул (nmID)"),("name","Название"),
    ("cost","Себестоимость, руб"),("packaging","Упаковка, руб"),
    ("logistics_forward","Логистика прямая, руб"),("logistics_backward","Логистика обратная, руб"),
    ("buyout_rate","Процент выкупа (напр. 0.7)"),("commission","Комиссия WB (напр. 0.17)"),
    ("acquiring","Эквайринг (напр. 0.015)"),("tax_rate","Налог (напр. 0.06)"),
    ("opex_rate","Операционные расходы (напр. 0.05)"),("min_margin","Мин. маржа (напр. 0.15)"),
    ("min_profit","Мин. прибыль, руб"),("target_profit","Целевая прибыль, руб"),
]
